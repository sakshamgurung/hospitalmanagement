...
<body background="img/trelloback5.png" style="margin: 0;">
		<div style="color:rgb(255, 81, 81);position: absolute;left:650px;">
		  ...
		  <a href="php/logout.php">
            <img class="logout-icon" src="http://myhost/semester%204/HospitalManagementProject/img/logout33.png" style="width: 50px;height:50px;margin-left:1180px;margin-top: 0px;">
          </a>
      <div class="container" style="position: relative;float:right; background:#2d353a;width: 60%px;height: 90%;margin-top: 0px;margin-right: 250px;opacity: 0.9;border-radius: 30px;padding-left: 50px;padding-right: 50px;">
      	...
      	<!-- <div class="profile-image" style="border:dashed;width:200px;height: 200px;float: right;margin-right:60px; margin-top: 50px;color: white;padding-left:10px; ">
			...
			<form method="POST" action="php/preparedSqlForNewStaff.php">
			      ...
			      <div class="container1">
			      		...
			      		<h3 style="font-size: 15px;color: white;">(compolsary for all staff)</h3>
			      		    ...
			      		    <p>
			      				...
			      				<input type="text" name="middleName" placeholder="Middle Name" style="width: 400px;height: 25px;border-radius: 30px;outline: none;text-align: center;">
			      		    </p>
			      			<p>
    	...
    	<ul style="list-style-type: none;">
	        <li class="current" style="text-align: center;">
	          ...
	          <br><a class="newstaff" href="newStaff.php"><img src="img/rec.png" style="height: 100px;width: 100px;margin-left: 5px;"><h2 style="text-align: center;">New Staff</h2></a></li> 
	            ...
	            <li style="text-align: center;">
	          <br><a class="staffprofile" href="php/htmlForStaffTable.php"><img src="img/stfpro.png" style="height: 100px;width: 100px;margin-left: 5px;"><h2 style="text-align: center;">Staff List</h2></a></li>  
	       	<li style="text-align: center;">
	          	<a class="doctorprofile" href="php/htmlForDoctorTable.php"><img src="http://myhost/semester%204/HospitalManagementProject/img/stfpro.png" style="height: 100px;width: 100px;margin-left: 5px;"><h2 style="text-align: center;">Doctor List</h2></a>
	        </li>
	            <li style="text-align: center;">
	          <br><a class="PatientList" href="php/htmlForPatientTableForAdmin.php"><img src="img/pat.png" style="height: 100px;width: 100px;margin-left: 5px;"><h2 style="text-align: center;">Patient List</h2></a></li>
    	</ul>     
   	</div> 
</body>
</html>