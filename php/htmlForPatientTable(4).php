			 	...
			 	<div id="nav">
			    	<ul style="list-style-type: none;">
						...
						<li class="current" style="text-align: center;">
				         <a class="doctorprofile" href="../doctorProfile.php"><img src="../img/adm2.png" style="height: 100px;width: 100px;"><h2 style="text-align: center;">Doctor Profile</h2></a>
						<li style="text-align: center;">
				          <a class="PatientList" href="htmlForPatientTable(1).php"><img src="../img/pat.png" style="height: 100px;width: 100px;margin-left: 5px;"><h2 style="text-align: center;">Patient Details</h2>
				          </a>
				      	</li>
			    	</ul>     
			 	</div> 
