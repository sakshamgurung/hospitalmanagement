   ...
   <div id="nav">
      ...
      <ul style="list-style-type: none;">
        ...
        <li style="text-align: center;" class="current3">
          <br><a class="PatientList" href="php/htmlForPatientTable(1).php"><img src="img/pat.png" style="height: 100px;width: 100px;margin-left: 5px;"><h2 style="text-align: center;">Patient Table</h2></a></li>
          </ul>
